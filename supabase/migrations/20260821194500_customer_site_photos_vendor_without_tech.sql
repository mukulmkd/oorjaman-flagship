-- Allow assigned vendors to read customer site photos before a technician is assigned.
-- Admin already bypasses via is_admin(); path still must match booking/subscription address.
